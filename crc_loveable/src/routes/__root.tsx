  ...
  head: () => ({
    meta: [
      ...
      { title: "CRC, GSTU — Come For Road Child" },
      {
        name: "description",
        content:
          "Come For Road Child (CRC), GSTU Branch — a student volunteer organisation educating and supporting street children in Bangladesh since 2016.",
      },
      { name: "author", content: "Come For Road Child, GSTU" },
