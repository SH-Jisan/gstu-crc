...
export default function JaagoFooter() {
  return (
    <>
            ...
            <div className="flex flex-col justify-start space-y-4">
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col text-left leading-none">
                  ...
                  <span className="text-[9px] font-bold text-[#e6000a] tracking-tight mt-0.5">
            ...
            <div className="flex flex-col justify-start">
              ...
              <ul className="text-gray-300 flex flex-col gap-3.5 text-sm">
                ...
                <li className="pt-2 text-xs text-gray-400 flex items-center gap-1">
                  ...
                  <Heart className="w-3.5 h-3.5 text-[#e6000a] fill-[#e6000a]" />
      ...
      {/* Bottom Copyright */}
      <div className="bg-[#07080b] flex justify-center py-4 border-t border-gray-900">
